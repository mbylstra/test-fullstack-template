...
#   timestamp: 2026-01-11T12:04:05+00:00
...
class CreateNoteRequest(BaseModel):
    ...
    title: Annotated[str, Field(description='The note title')]
    content: Annotated[str, Field(description='The note content')]
...
class Note(BaseModel):
    ...
    id: Annotated[str, Field(description='Unique identifier for the note')]
    title: Annotated[str, Field(description='The note title')]
    content: Annotated[str, Field(description='The note content')]
    user_id: Annotated[str, Field(description='ID of the user who owns this note')]
    date_created: Annotated[
        AwareDatetime, Field(description='When the note was created')
    ]
    date_updated: Annotated[
        AwareDatetime, Field(description='When the note was last updated')
    ]
...
class UpdateNoteRequest(BaseModel):
    ...
    title: Annotated[Optional[str], Field(description='The note title')] = None
    content: Annotated[Optional[str], Field(description='The note content')] = None
